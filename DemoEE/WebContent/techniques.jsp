...
<label id="query" style="visibility:hidden;">${Technique}</label>
<label id="json" style="visibility:hidden;">${Results}</label>
   ...
   <div class = "footer">
    ...
    { 
    	...
    	var url = "http://localhost:8080/DemoEE/showitemstechnique?mname="+mname+"&query="+query;
    ...
    {
    	document.getElementById('heading').innerHTML="<b>Search results for Technique: <i>"+query+"</i> at '"+mname+"'</b>";
    	var obj=eval ("(" + data + ")");
    	var myTable="<table>";
    ...
    function myFunction()
    {
    	document.getElementById('heading').innerHTML="<b>Search results for Technique: <i>"+query+"</i></b>";
