...
/**
 * Servlet implementation class showitemsartist
 */
public class showitemsartist extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public showitemsartist() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			...
			String q = "select Title,Image_URL,Technique from museum where Museum_Name='"+mname+"' and Artist like '%"+query+"%' LIMIT 10;" ;
